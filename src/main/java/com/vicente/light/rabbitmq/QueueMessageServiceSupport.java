...
public class QueueMessageServiceSupport implements QueueMessageService {
    ...
    @Override
    public void send(Object message, String exchangeEnum, String queueEnum) throws Exception {
        //设置回调为当前类对象
        rabbitTemplate.setConfirmCallback(this);
        //构建回调id为uuid
        CorrelationData correlationId = new CorrelationData(UUID.randomUUID().toString());
        //发送消息到消息队列
        rabbitTemplate.convertAndSend(exchangeEnum, queueEnum,message,correlationId);
    }
